...
public class RobotContainer {
  ...
  private cartesianMecanumDrive m_cartesianMecanumDrive = new cartesianMecanumDrive(m_driveSubsystem, m_sensors, ()-> m_driveController.getRawAxis(1), 
    ()-> m_driveController.getRawAxis(0), () -> m_driveController.getRawAxis(4));
